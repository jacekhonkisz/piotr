        ...
        try {
          ...
          try {
            ...
            if (!filename) {
              ...
              const startDate = formatDateForFilename(periodStartDate);
              const endDate = formatDateForFilename(periodEndDate);
              const okresRaportu = `${startDate}-${endDate}`;
              const sanitizedClientName = clientData.name?.replace(/[^\w\s-]/g, '').trim() || 'Klient';
