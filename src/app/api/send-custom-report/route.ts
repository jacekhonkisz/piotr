    ...
    const monthlyReportData = {
      ...
      metricLabels: {
        googleAds: {
          ...
          click_to_call: labelFor('google', 'contact', 'click_to_call', 'Kliknięcia w numer telefonu/połączenia z reklam'),
        ...
        metaAds: {
          ...
          click_to_call: labelFor('meta', 'contact', 'click_to_call', 'Kliknięcia w numer telefonu/połączenia z reklam'),
          booking_step_1: labelFor('meta', 'funnel', 'booking_step_1', 'Wyszukiwania (booking step 1)'),
          booking_step_2: labelFor('meta', 'funnel', 'booking_step_2', 'Wyświetlenia zawartości (booking step 2)'),
          booking_step_3: labelFor('meta', 'funnel', 'booking_step_3', 'Zainicjowanie finalizacji zakupu (booking step 3)'),
