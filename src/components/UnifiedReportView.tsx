  ...
  return (
    <div className="bg-gradient-to-br from-purple-600 to-blue-600 rounded-xl p-6 text-white mb-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-6 gap-4">
        ...
        <div className="bg-white/10 rounded-lg p-4 text-center">
          <div className="text-2xl font-bold">{(totals.averageCtr !== undefined && totals.averageCtr !== null
            ? totals.averageCtr
            : (totals.totalImpressions > 0 ? (totals.totalClicks / totals.totalImpressions) * 100 : 0)).toFixed(2)}%</div>
