...
async function testTabSwitchingFixV2() {
  console.log('🎯 Testing Tab Switching Fix V2...\n');
  ...
  try {
    ...
    console.log('   ✅ Improved tab state management');
    console.log('   ✅ Better error handling');
    console.log('   ✅ Double initialization (immediate + delayed)');
    ...
    console.log('   • Duplicate tables appearing');
...
// Run the test
testTabSwitchingFixV2().catch(console.error); 