...
async function testDashboardDataFlow() {
  ...
  try {
    ...
    // Step 1: Test the exact same API call the dashboard makes
    console.log('\n1️⃣ DASHBOARD API CALL SIMULATION:');
    ...
    try {
      ...
      if (campaignsData.data && campaignsData.data.length > 0) {
        ...
        // Step 3: Test what the dashboard should display
        ...
        // Step 4: Compare with what was showing before
        console.log('\n4️⃣ COMPARISON WITH OLD DATA:');
        console.log('='.repeat(50));
        console.log('📊 OLD (INCORRECT) VALUES:');
        console.log(`   Phone Contacts: 0`);
        console.log(`   Reservation Steps: 228`);
        console.log(`   Reservations: 245`);
        console.log(`   Reservation Value: 135,894 zł`);
        console.log(`   ROAS: 38.38x`);
        console.log(`   Cost per Reservation: 14.45 zł`);
        
        console.log('\n📊 NEW (CORRECT) VALUES:');
        console.log(`   Phone Contacts: ${conversionData.click_to_call}`);
        console.log(`   Reservation Steps: ${conversionData.booking_step_1}`);
        console.log(`   Reservations: ${conversionData.purchase}`);
        console.log(`   Reservation Value: ${conversionData.purchase_value.toFixed(2)} zł`);
        console.log(`   ROAS: ${conversionData.roas.toFixed(2)}x`);
        console.log(`   Cost per Reservation: ${conversionData.cost_per_reservation.toFixed(2)} zł`);
        ...
        if (isCorrect) {
          ...
          console.log('✅ Live API data is being used');
          console.log('✅ Conversion tracking is working');
        ...
        console.log('4. Verify the dashboard shows the values above');
